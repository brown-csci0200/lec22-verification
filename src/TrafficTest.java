...
//    private TransitionSystemFull makeTrafficSystem(TrafficState start) {
//        TransitionSystemFull ts = new TransitionSystemFull(start);
...
//        TransitionSystemFull goodSystem = makeTrafficSystem(new TrafficState(RED, GREEN));
...
//        TransitionSystemFull badSystem = makeTrafficSystem(new TrafficState(RED, RED));
